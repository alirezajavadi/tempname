...
sock.listen()
msc_sock , msc_address = sock.accept()
...
PK_de = PK_de
V_1= V_1
V_2= "eacacd909708c55f6e39a88991ee376db4c251d716f2b400d28ab6112aca720a"
ID_ap=76450
PK_ap=5241
m2 = f"{TID_i},{ID_msc},{PK_de},{V_1},{V_2},{ID_ap},{PK_ap}"

print(f"\033[96m[+] Sending Stored M2={{TID_i, ID_MSC, PK_DE, V_1, V_2, ID_AP, PK_AP}} : {{{m2}}}\033[0m")
msc_sock.send(m2.encode('utf-8'))

# receiving m3
m3 = msc_sock.recv(10240).decode('utf-8')
print(f"\033[92m[ OK ]  M3={{Auth_AP_G_date, t1, t2, AT_a, AT_b, TID_G}} has been received: {{{m3}}}\033[0m")
m3 = m3.split(",")
